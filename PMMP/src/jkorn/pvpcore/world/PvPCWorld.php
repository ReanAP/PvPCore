...
class PvPCWorld implements IKBObject
{
    ...
    {
        $this->localizedLevel = $world->getFolderName();
        $this->world = $world;
    }
    ...
    public function equals($object): bool
    {
        if ($object instanceof PvPCWorld) {
            ...
            if ($world instanceof World && $this->world instanceof World) {
                return Utils::areLevelsEqual($this->world, $world);
            }
    ...
    public function canUseKnocback(Player $player1, Player $player2): bool
    {
        ...
        return Utils::areLevelsEqual($player1->getWorld(), $this->world)
            && Utils::areLevelsEqual($player2->getWorld(), $this->world);
    }
